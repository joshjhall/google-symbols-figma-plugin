  ...
  try {
    ...
    if (hasExistingMapping) {
      ...
      if (newIcons.length > 0) {
        console.log(
          '📚 Assigning new icons alphabetically (like adding books to library shelves)...\n'
        );
        ...
        for (const newIcon of newIcons) {
          ...
          console.log(
            `   ${newIcon} → ${assignedCategory.name} (now ${assignedCategory.count} icons, ${assignedCategory.firstIcon}...${assignedCategory.lastIcon})`
          );
